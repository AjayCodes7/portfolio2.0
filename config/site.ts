export const siteConfig = {
    name: 'iamajay.tech',
    url: 'https://iamajay.tech',
    ogImage: 'https://drive.google.com/file/d/16FQ4yAxerjVcY4qtV6a4MT3S9AsIKWRf/view?usp=sharing',
    description: 'Portfolio of Ajay Kommana',
    links: {
        shadcn: 'https://ui.shadcn.com/',
        telegram: 'https://t.me/ajaykommana',
